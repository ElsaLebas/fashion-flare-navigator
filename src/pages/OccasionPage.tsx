      ...
      <main className="pb-16">
        <div className="relative h-80 bg-fashion-cream overflow-hidden">
          <div className="absolute inset-0">
            <img src={occasion.image} alt={occasion.title} className="w-full h-full object-cover object-center" />
          ...
          <div className="relative h-full container-custom flex flex-col justify-center items-center text-center">
            <h1 className="text-white font-serif text-4xl md:text-5xl font-medium mb-4">{occasion.title}</h1>
          </div>
        </div>
          ...
          <InstantSearch searchClient={searchClient} indexName="fashion">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="col-span-3">
                <div className="mb-6">
                  <p className="text-sm text-gray-600">Showing {occasion.title} products</p>
                </div>
